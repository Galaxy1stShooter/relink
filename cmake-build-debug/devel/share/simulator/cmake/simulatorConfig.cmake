...
if("TRUE" STREQUAL "TRUE")
  set(simulator_SOURCE_PREFIX /home/melodies/SYSU_ROBOT/Communication_Relay/src/communication-relay/simulator)
  set(simulator_DEVEL_PREFIX /home/melodies/SYSU_ROBOT/Communication_Relay/src/communication-relay/cmake-build-debug/devel)
  ...
  set(simulator_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/melodies/SYSU_ROBOT/Communication_Relay/src/communication-relay/simulator/include " STREQUAL " ")
  set(simulator_INCLUDE_DIRS "")
  set(_include_dirs "/home/melodies/SYSU_ROBOT/Communication_Relay/src/communication-relay/simulator/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simulator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/melodies/SYSU_ROBOT/Communication_Relay/src/communication-relay/simulator/${idir}'.  ${_report}")
    endif()
