...
if("TRUE" STREQUAL "TRUE")
  set(multi_map_server_SOURCE_PREFIX /home/melodies/SYSU_ROBOT/Communication_Relay/src/communication-relay/Utils/uav_simulator/Utils/multi_map_server)
  set(multi_map_server_DEVEL_PREFIX /home/melodies/SYSU_ROBOT/Communication_Relay/src/communication-relay/cmake-build-debug/devel)
  ...
  set(multi_map_server_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/melodies/SYSU_ROBOT/Communication_Relay/src/communication-relay/cmake-build-debug/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/melodies/SYSU_ROBOT/Communication_Relay/src/communication-relay/Utils/uav_simulator/Utils/multi_map_server/${idir}'.  ${_report}")
    endif()
